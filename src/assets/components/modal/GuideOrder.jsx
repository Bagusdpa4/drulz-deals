...
const STEPS = [
  ...
  },
  {
    number: 2,
    icon: HiSquares2X2,
    title: "Pilih Kategori Minuman",
    description: "Pilih kategori minuman yang kamu inginkan.",
  },
  {
    number: 3,
    icon: HiHeart,
  ...
  },
  {
    ...
    icon: HiShoppingCart,
    title: "Cek Keranjang",
    description: "Cek minuman yang kamu pilih di keranjang (pojok kiri bawah).",
  },
  {
    number: 8,
